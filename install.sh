...
echo "  ./check_server_logs.py server1.example.com"
echo ""
echo "  # С автоочисткой ZFS"
echo "  ./check_server_logs.py server1.example.com --cleanup-threshold 85"
echo ""
echo "  # Несколько серверов"
echo "  ./check_server_logs.py server1.example.com server2.example.com server3.example.com"
echo ""
